...
그런데 이 프로젝트가 쌓아 온 데이터(1,000자의 훈·음·총획, 815개 한자어,
...
| [글자 1,000장](https://hanjasajeon.pages.dev/hanja/급수/8급) | 훈·음·총획·급수, 쓰이는 낱말, 글자를 이루는 조각, 획순               |
| [낱말 815장](https://hanjasajeon.pages.dev/hanja/낱말)       | 두 글자 한자어. 소리가 같고 한자가 다른 낱말도 갈라 준다             |
...
| `npm run audit:seo`         | 구운 사전 1,845장을 전수 검사 (제목·설명·canonical 겹침) |
